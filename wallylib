...
local credits = {"Ayano#0002","https://discord.gg/4qxj7FA"}
local defaults; do
    local dragger = {}; do
    ...
    local types = {}; do
        ...
        function types:Dropdown(name, options, callback)
            ...
            self:Resize();
            local function search(array, value)
            ...
            local function reload(self, array, keep)
                options = array;
                if keep ~= true and search(array, location[flag]) ~= "nil" then
